...
const exerciseDetails = () => {
  ...
  return (
    <View className="flex flex-1">
      ...
      <TouchableOpacity
        onPress={() => router.back()}
        className="mx-2 absolute rounded-full mt-10 right-0 mr-5"
      >
      ...
      >
        <Animated.Text
          ...
          className="font-semibold to-neutral-800 tracking-wide"
        >
          {item.name}
        </Animated.Text>
        ...
        <Animated.Text
          ...
          style={{ fontSize: hp(2) }}
          className="to-neutral-700 tracking-wide"
        >
          Equipment{" "}
